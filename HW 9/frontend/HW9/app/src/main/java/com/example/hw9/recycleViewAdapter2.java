...
public class recycleViewAdapter2 extends RecyclerView.Adapter<recycleViewAdapter2.MovieDataViewHolder> {

    private Context mContext;
    private List<castData> movieDataList;

    recycleViewAdapter2(Context mContext,List <castData> movieDataList){
